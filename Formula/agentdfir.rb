...
class Agentdfir < Formula
  ...
  url "https://github.com/efij/AgentDFIR/archive/refs/tags/v2.6.0.tar.gz"
  sha256 "d24558ef9b0f2b0981ef9d2cca8283a4e4ab5ccd7a1118564a769f7f20e166fc"
  license "MIT"
  ...
  def install
    ldflags = "-s -w -X github.com/efij/AgentDFIR/v2/internal/version.Version=v2.6.0"
    system "go", "build", *std_go_args(ldflags: ldflags), "./cmd/agentdfir"
  end

  test do
    assert_match "agentdfir v2.6.0", shell_output("#{bin}/agentdfir version")
  end
end
