...
class Agentdfir < Formula
  ...
  url "https://github.com/efij/AgentDFIR/archive/refs/tags/v0.15.0.tar.gz"
  sha256 "287a475f4d92bb6d995ae28fbcd4a470ca13b90c69feef7bb873de5bd19a72b9"
  license "MIT"
  ...
  def install
    ldflags = "-s -w -X github.com/efij/AgentDFIR/internal/version.Version=v0.15.0"
    system "go", "build", *std_go_args(ldflags: ldflags), "./cmd/agentdfir"
  end

  test do
    assert_match "agentdfir v0.15.0", shell_output("#{bin}/agentdfir version")
  end
end
